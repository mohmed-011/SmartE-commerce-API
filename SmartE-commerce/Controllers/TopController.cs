        ...
        public async Task<IActionResult> GetTopRateItem()
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(_connectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand("Sp_GetTopRateItem", connection))
                    {
        ...
        public async Task<IActionResult> GetSold()
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(_connectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand("Sp_GetTopSoldItem", connection))
                    {
                        command.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<IActionResult> GetTrending()
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(_connectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand("Sp_GetTopTrendingItem", connection))
                    {
                        command.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<IActionResult> GetMostViewed()
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(_connectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand("Sp_GetMostViewedItems", connection))
                    {
                        command.CommandType = CommandType.StoredProcedure;
